(function () {
  ...
  "Personalizado": "自定义",
  "Protegido": "受保护",
  "Excluir tipo personalizado": "删除自定义类型",
  "Restaurar padrão do sistema": "恢复系统默认值",
  "Remover a personalização deste tipo de acesso e restaurar o padrão do sistema?": "是否移除此访问类型的自定义设置并恢复系统默认值？",
...
"Usa a planilha como fonte final: campos vazios limpam dados antigos e cadastros fora dela são recusados, exceto o usuário logado.": "以表格作为最终数据源：空字段会清除旧数据，不在表格中的注册将被拒绝，当前登录用户除外。",
...
"Substituir cadastros? Campos vazios na planilha limparão dados antigos. Usuários que não estiverem na planilha serão recusados, exceto o usuário logado.": "要替换注册数据吗？表格中的空字段会清除旧数据。不在表格中的用户将被拒绝，当前登录用户除外。",
